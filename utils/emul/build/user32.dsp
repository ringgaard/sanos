...
# ADD CPP /nologo /MT /W3 /O2 /X /I "..\include" /u /D "USER32_LIB" /FAs /YX"os.h" /FD /c
...
# ADD LINK32 os.lib /nologo /base:"" /entry:"DllMain" /dll /map /machine:I386 /nodefaultlib /implib:"..\lib/user32.lib" /libpath:"..\lib"
...
SOURCE=..\src\user32\user32.c
# End Source File
# Begin Source File

SOURCE=..\src\user32\user32.def
# End Source File
# Begin Source File
