...
tools\mkdfs -d img\usr\BOOTIMG.BIN -b bin\cdboot -l bin\osldr.dll -k bin\krnl.dll -c 512 -I 8192 -i -f -S . -F build\bootcd.lst
tools\mkisofs -no-emul-boot -J -c BOOTCAT.BIN -b BOOTIMG.BIN -o img\sanos.iso img\usr
