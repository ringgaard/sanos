...
typedef struct {
  ...
  union {
    long int a_val;             // Integer value
    void *a_ptr;                // Pointer value
    void (*a_fcn) (void);       // Function pointer valu
  } a_un;
} Elf64_auxv_t;
...
#define DT_MIPS_RLD_TXT_RES_ADDR  0x7000002d // Address of rld_text_rsolve
...
#define R_ALPHA_OP_STORE        13      // OP stack pop and stor
...
#define R_PPC_ADDR24            2       // 26 bit address, 2 bits ignored
#define R_PPC_ADDR16            3       // 16 bit absolute address
#define R_PPC_ADDR16_LO         4       // lower 16 bit of absolute address
#define R_PPC_ADDR16_HI         5       // high 16 bit of absolute address
#define R_PPC_ADDR16_HA         6       // adjusted high 16 bit
#define R_PPC_ADDR14            7       // 16 bit address, 2 bits ignored
