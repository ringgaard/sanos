...
#define lua_readline(L,b,p) \
        ...
        readline(b, LUA_MAXINPUT) >= 0)  /* get line */
...
*/
#if defined(SANOS)
#define LUA_LDIR "/usr/lua/"
#define LUA_CDIR "/usr/bin/"
#define LUA_PATH_DEFAULT "/usr/lua/?.lua;./?.lua"
#define LUA_CPATH_DEFAULT "/usr/bin/?.dll;./?.dll"
#else
#if defined(_WIN32)	/* { */
/*
